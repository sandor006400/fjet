...
public class TerrainFactory {
    ...
    private void initTerrains(Context c){
        ...
        if (c != null) {
            ...
            // Grassland
            Drawable gD = c.getResources().getDrawable(R.drawable.tex_terrain_06, c.getTheme());
            ...
            // Oasis
            Drawable oD = c.getResources().getDrawable(R.drawable.tex_terrain_13, c.getTheme());
            Terrain oT = new Terrain(Terrain.TerrainType.OASIS, oD, 1.0f, 1.0f);
            this.terrainsMap.put(Terrain.TerrainType.OASIS.ordinal(), oT);

            // Ocean
            Drawable ocD = c.getResources().getDrawable(R.drawable.tex_terrain_13, c.getTheme());
            ...
            // Plains
            Drawable pD = c.getResources().getDrawable(R.drawable.tex_terrain_14, c.getTheme());
